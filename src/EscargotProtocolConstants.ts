...
export enum SERVER {
  ...
  ESCARGOT_DEBUGGER_VARIABLE = 35,
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_VARIABLE_8BIT = 36,
  ESCARGOT_DEBUGGER_VARIABLE_8BIT_END = 37,
  ESCARGOT_DEBUGGER_VARIABLE_16BIT = 38,
  ESCARGOT_DEBUGGER_VARIABLE_16BIT_END = 39,
}
...
export enum CLIENT {
  ...
  ESCARGOT_DEBUGGER_GET_SCOPE_VARIABLES = 11,
}
...
export enum ESCARGOT_DEBUGGER_SCOPE_VARIABLES {
  ...
  ESCARGOT_DEBUGGER_VARIABLE_OBJECT = 8,
  ESCARGOT_DEBUGGER_VARIABLE_ARRAY = 9,
  ESCARGOT_DEBUGGER_VARIABLE_FUNCTION = 10,
