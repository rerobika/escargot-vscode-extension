...
export enum SERVER {
  ...
  // These four must be in the same order.
  ESCARGOT_DEBUGGER_PRINT_8BIT = 40,
  ESCARGOT_DEBUGGER_PRINT_8BIT_END = 41,
  ESCARGOT_DEBUGGER_PRINT_16BIT = 42,
  ESCARGOT_DEBUGGER_PRINT_16BIT_END = 43,
}
